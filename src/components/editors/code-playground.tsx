...
const TABS: { id: TabType; label: string; filename: string; icon: React.ElementType; accent: string }[] = [
 ...
 { id: 'css', label: 'CSS', filename: 'style.css', icon: Palette, accent: '#b8860b' },
...
setInterval(function() {
 ...
 "linear-gradient(" + hue +
 "deg, #d4a017, #b8860b, #d4a017, #ec4899)";
...
function renderTokenizedCode(tokens: Token[]): React.ReactNode[] {
 ...
 <span className="select-none text-[#1a1a1a]/[0.12] w-8 text-right mr-4 shrink-0 text-xs">
 {index + 1}
 </span>
...
export function CodePlaygroundSection() {
 ...
 >
 <div className="inline-flex items-center gap-2 px-4 py-2 border border-[#d4a017]/20 bg-[#d4a017]/[0.06] mb-6">
 <Code2 className="w-3.5 h-3.5 text-[#d4a017]" />
 <span className="text-xs font-mono text-[#d4a017]/80 uppercase tracking-widest">
 ...
 <p className="font-mono text-sm sm:text-base text-[#6b6356]/40 tracking-wide max-w-lg mx-auto">
 ...
 <Eye className="w-4 h-4 text-[#d4a017]/60" />
 <h3 className="font-mono text-sm text-[#6b6356]/50 tracking-widest uppercase">Live Editor</h3>
 ...
 <motion.button
 onClick={handleReset}
 className="flex items-center gap-1.5 px-2.5 py-1.5 text-[11px] font-mono text-[#6b6356]/50 hover:text-[#1a1a1a]/70 hover:bg-[#ebe5d0] transition-colors"
 ...
 whileHover={{ scale: 1.05, boxShadow: '0 0 20px rgba(212,160,23,0.2)' }}
 whileTap={{ scale: 0.95 }}
 title="Run code"
 >
 ...
 <pre
 ref={preRef}
 className="absolute inset-0 w-full h-full p-4 overflow-hidden pointer-events-none custom-scrollbar font-mono text-xs leading-[1.625rem] selection:bg-[#d4a017]/30"
 ...
 className="absolute inset-0 w-full h-full resize-none bg-transparent text-transparent caret-[#f8f8f2] outline-none p-4 font-mono text-xs leading-[1.625rem] overflow-auto custom-scrollbar selection:bg-[#d4a017]/30"
 style={{ tabSize: 2 }}
 spellCheck={false}
 autoCapitalize="off"
 autoCorrect="off"
 ...
 <Eye className="w-3.5 h-3.5 text-[#6b6356]/35" />
 <span className="font-mono text-[11px] text-[#6b6356]/35">Preview</span>
 </div>
 {/* Fake URL bar */}
 ...
 <span className="font-mono text-[10px] text-[#6b6356]/20">Auto-refresh (300ms)</span>
 </div>
 </motion.div>
 </div>
 </motion.div>
 ...
 <div>
 <span className="font-mono text-xs text-[#6b6356]/50">{item.label}</span>
 <span className="font-mono text-[10px] text-[#6b6356]/20 ml-2 hidden sm:inline">{item.sub}</span>
 </div>
 {i < 2 && (
 <span className="hidden sm:block w-px h-4 bg-[#1a1a1a]/10 ml-4 sm:ml-8" />
 )}
 </div>
 ))}
 </motion.div>
